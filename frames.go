...
var (
	...
	// powered by a timer, power it by this event source. The timer you have may
	// fire more often than the underlying system updates the screen, so it
